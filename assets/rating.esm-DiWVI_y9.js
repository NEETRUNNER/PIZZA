...
`,Te=j.extend({defaultProps:{__TYPE:"Rating",id:null,value:null,disabled:!1,readOnly:!1,stars:5,cancel:!0,style:null,className:null,tooltip:null,tooltipOptions:null,onChange:null,onIcon:null,offIcon:null,cancelIcon:null,cancelIconProps:null,onIconProps:null,offIconProps:null,children:void 0},css:{classes:Nr,styles:$r}});function Rt(r,t){var e=Object.keys(r);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(r);t&&(n=n.filter(function(a){return Object.getOwnPropertyDescriptor(r,a).enumerable})),e.push.apply(e,n)}return e}function Ae(r){for(var t=1;t<arguments.length;t++){var e=arguments[t]!=null?arguments[t]:{};t%2?Rt(Object(e),!0).forEach(function(n){Ar(r,n,e[n])}):Object.getOwnPropertyDescriptors?Object.defineProperties(r,Object.getOwnPropertyDescriptors(e)):Rt(Object(e)).forEach(function(n){Object.defineProperty(r,n,Object.getOwnPropertyDescriptor(e,n))})}return r}var Rr=v.memo(v.forwardRef(function(r,t){var e=Ht(),n=v.useContext(le),a=Te.getProps(r,n),o=v.useState(-1),u=$t(o,2),i=u[0],l=u[1],s=v.useState(!0),f=$t(s,2),d=f[0];f[1];var g=v.useRef(null),p=Te.setMetaData({props:a}),h=p.ptm,w=p.cx,C=p.isUnstyled;Kt(Te.css.styles,C,{name:"rating"});var m=function(S,O){return h(O,{context:{active:S<=a.value}})},y=!a.disabled&&!a.readOnly,E=y?0:null,L=function(S,O){y&&a.onChange&&a.onChange({originalEvent:S,value:O,stopPropagation:function(){S==null||S.stopPropagation()},preventDefault:function(){S==null||S.preventDefault()},target:{name:a.name,id:a.id,value:O}}),l(O),S.preventDefault()},$=function(S){y&&a.onChange&&a.onChange({originalEvent:S,value:null,stopPropagation:function(){S==null||S.stopPropagation()},preventDefault:function(){S==null||S.preventDefault()},target:{name:a.name,id:a.id,value:null}}),S.preventDefault()},M=function(S,O){switch(S.key){case"Enter":case"Space":L(S,O),S.preventDefault();break;case"ArrowLeft":case"ArrowUp":S.preventDefault(),L(S,a.value-1<1?a.stars:a.value-1);break;case"ArrowRight":case"ArrowDown":S.preventDefault(),L(S,a.value+1>a.stars?1:a.value+1);break}},z=function(S,O){l(O)},K=function(S){l(-1)},H=function(S){S.key==="Enter"&&$(S)},q=function(){return Array.from({length:a.stars},function(S,O){return O+1}).map(function(S){var O=S<=a.value,Y=e({className:w("onIcon")},m(a.value,"onIcon")),G=e({className:w("onIcon")},m(a.value,"offIcon")),he=O?{type:a.onIcon||v.createElement(Zt,Y)}:{type:a.offIcon||v.createElement(Yt,G)},Me=xt.getJSXIcon(he.type,O?Ae({},Y):Ae({},G),{props:a}),We=e({className:w("item",{active:O,focusedOptionIndex:i,isFocusVisibleItem:d,value:S}),"data-p-focused":S===i,tabIndex:E,onClick:function(te){return L(te,S)},onKeyDown:function(te){return M(te,S)},onFocus:function(te){return z(te,S)},onBlur:function(te){return K()}},m(a.value,"item"));return v.createElement("div",Re({},We,{key:S}),Me)})},J=function(){if(a.cancel){var S=e({className:w("cancelIcon")},h("cancelIcon")),O=a.cancelIcon||v.createElement(Vt,S),Y=xt.getJSXIcon(O,Ae(Ae({},S),a.cancelIconProps),{props:a}),G=e({className:w("cancelItem"),onClick:$,tabIndex:E,onKeyDown:H},h("cancelItem"));return v.createElement("div",G,Y)}return null};v.useImperativeHandle(t,function(){return{props:a,getElement:function(){return g.current}}});var se=I.isNotEmpty(a.tooltip),A=e({ref:g,id:a.id,className:re(a.className,w("root")),style:a.style},Te.getOtherProps(a),h("root")),ee=J(),_=q();return v.createElement(v.Fragment,null,v.createElement("div",A,ee,_),se&&v.createElement(Xt,Re({target:g,content:a.tooltip,pt:h("tooltip")},a.tooltipOptions)))}));Rr.displayName="Rating";export{Rr as R};
